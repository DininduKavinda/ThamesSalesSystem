            ...
            <div class="swiper mt-3 px-3" x-init="$nextTick(()=>new Swiper($el,{  slidesPerView: 'auto', spaceBetween: 16}))">
              <div class="swiper-wrapper">
                <div class="swiper-slide relative flex h-28 w-48 flex-col overflow-hidden rounded-xl bg-gradient-to-br from-purple-500 to-indigo-600 p-3">
                  <div class="grow">
                    <img class="h-3" src="{{asset('images/payments/cc-visa-white.svg')}}" alt="image">
                  </div>
            ...
            <div class="mt-3 grid grid-cols-2 gap-3 px-3">
              <div class="rounded-lg bg-slate-100 p-2.5 dark:bg-navy-600">
                <div class="flex items-center space-x-2">
                  <img class="h-10 w-10" src="{{asset('images/logos/bitcoin.svg')}}" alt="image">
                  <div>
              ...
              <div class="rounded-lg bg-slate-100 p-2.5 dark:bg-navy-600">
                <div class="flex items-center space-x-2">
                  <img class="h-10 w-10" src="{{asset('images/logos/solana.svg')}}" alt="image">
                  <div>
                    <h2 class="font-medium tracking-wide text-slate-700 dark:text-navy-100">
                      SOL
                    </h2>
          ...
          <div class="mt-4">
            ...
            <div class="mt-3 space-y-3 px-2">
              <div class="flex justify-between space-x-2 rounded-lg bg-slate-100 p-2.5 dark:bg-navy-700">
                  ...
                  <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-2">
                      <div class="avatar h-7 w-7">
                        <img class="rounded-full" src="{{asset('images/avatar/avatar-20.jpg')}}" alt="avatar">
                      </div>
                      <div>
                ...
                <img src="{{asset('images/object/object-18.jpg')}}" class="h-20 w-20 rounded-lg object-cover object-center" alt="image">
              </div>
              ...
              <div class="flex justify-between space-x-2 rounded-lg bg-slate-100 p-2.5 dark:bg-navy-700">
                <div class="flex flex-1 flex-col justify-between">
                  ...
                  <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-2">
                      <div class="avatar h-7 w-7">
                        <img class="rounded-full" src="{{asset('images/avatar/avatar-19.jpg')}}" alt="avatar">
                      </div>
                      <div>
                        <p class="text-xs font-medium line-clamp-1">
                          Travis F.
                ...
                <img src="{{asset('images/object/object-2.jpg')}}" class="h-20 w-20 rounded-lg object-cover object-center" alt="image">
              </div>
              ...
              <div class="flex justify-between space-x-2 rounded-lg bg-slate-100 p-2.5 dark:bg-navy-700">
                <div class="flex flex-1 flex-col justify-between">
                  ...
                  <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-2">
                      <div class="avatar h-7 w-7">
                        <img class="rounded-full" src="{{asset('images/avatar/avatar-18.jpg')}}" alt="avatar">
                      </div>
                      <div>
                        <p class="text-xs font-medium line-clamp-1">
                          Alfredo E .
                ...
                <img src="{{asset('images/object/object-1.jpg')}}" class="h-20 w-20 rounded-lg object-cover object-center" alt="image">
              </div>
            </div>
          </div>
        ...
        <div x-show="activeTab === 'tabProjects'" x-transition:enter="transition-all duration-500 easy-in-out" x-transition:enter-start="opacity-0 [transform:translate3d(0,1rem,0)]" x-transition:enter-end="opacity-100 [transform:translate3d(0,0,0)]" class="is-scrollbar-hidden overflow-y-auto overscroll-contain px-3 pt-1">
          ...
          <div class="mt-4 rounded-lg border border-slate-150 p-3 dark:border-navy-600">
            <div class="flex items-center space-x-3">
              <img class="h-10 w-10 rounded-lg object-cover object-center" src="{{asset('images/illustrations/lms-ui.svg')}}" alt="image">
              <div>
            ...
            <div class="mt-3 flex items-center justify-between space-x-2">
              <div class="flex -space-x-3">
                <div class="avatar h-7 w-7 hover:z-10">
                  <img class="rounded-full ring ring-white dark:ring-navy-700" src="{{asset('images/avatar/avatar-16.jpg')}}" alt="avatar">
                </div>
                <div class="avatar h-7 w-7 hover:z-10">
                ...
                <div class="avatar h-7 w-7 hover:z-10">
                  <img class="rounded-full ring ring-white dark:ring-navy-700" src="{{asset('images/avatar/avatar-20.jpg')}}" alt="avatar">
                </div>
              </div>
          ...
          <div class="mt-4 rounded-lg border border-slate-150 p-3 dark:border-navy-600">
            <div class="flex items-center space-x-3">
              <img class="h-10 w-10 rounded-lg object-cover object-center" src="{{asset('images/illustrations/store-ui.svg')}}" alt="image">
              <div>
                <p class="font-medium leading-snug text-slate-700 dark:text-navy-100">
                  Store Dashboard
                </p>
            ...
            <div class="mt-3 flex items-center justify-between space-x-2">
              <div class="flex -space-x-3">
                <div class="avatar h-7 w-7 hover:z-10">
                  <img class="rounded-full ring ring-white dark:ring-navy-700" src="{{asset('images/avatar/avatar-17.jpg')}}" alt="avatar">
                </div>
                <div class="avatar h-7 w-7 hover:z-10">
                ...
                <div class="avatar h-7 w-7 hover:z-10">
                  <img class="rounded-full ring ring-white dark:ring-navy-700" src="{{asset('images/avatar/avatar-19.jpg')}}" alt="avatar">
                </div>
              </div>
              <button class="btn h-7 w-7 rounded-full bg-slate-150 p-0 font-medium text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80 dark:bg-navy-500 dark:text-navy-50 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 rotate-45" fill="none" viewbox="0 0 24 24" stroke="currentColor">
          ...
          <div class="mt-4 rounded-lg border border-slate-150 p-3 dark:border-navy-600">
            <div class="flex items-center space-x-3">
              <img class="h-10 w-10 rounded-lg object-cover object-center" src="{{asset('images/illustrations/chat-ui.svg')}}" alt="image">
              <div>
                <p class="font-medium leading-snug text-slate-700 dark:text-navy-100">
                  Chat Mobile App
                </p>
            ...
            <div class="mt-3 flex items-center justify-between space-x-2">
              <div class="flex -space-x-3">
                <div class="avatar h-7 w-7 hover:z-10">
                  <img class="rounded-full ring ring-white dark:ring-navy-700" src="{{asset('images/avatar/avatar-5.jpg')}}" alt="avatar">
                </div>
                <div class="avatar h-7 w-7 hover:z-10">
                ...
                <div class="avatar h-7 w-7 hover:z-10">
                  <img class="rounded-full ring ring-white dark:ring-navy-700" src="{{asset('images/avatar/avatar-11.jpg')}}" alt="avatar">
                </div>
              </div>
              <button class="btn h-7 w-7 rounded-full bg-slate-150 p-0 font-medium text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80 dark:bg-navy-500 dark:text-navy-50 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 rotate-45" fill="none" viewbox="0 0 24 24" stroke="currentColor">
          ...
          <div class="mt-4 rounded-lg border border-slate-150 p-3 dark:border-navy-600">
            <div class="flex items-center space-x-3">
              <img class="h-10 w-10 rounded-lg object-cover object-center" src="{{asset('images/illustrations/nft.svg')}}" alt="image">
              <div>
                <p class="font-medium leading-snug text-slate-700 dark:text-navy-100">
                  NFT Marketplace App
                </p>
            ...
            <div class="mt-3 flex items-center justify-between space-x-2">
              <div class="flex -space-x-3">
                <div class="avatar h-7 w-7 hover:z-10">
                  <img class="rounded-full ring ring-white dark:ring-navy-700" src="{{asset('images/avatar/avatar-8.jpg')}}" alt="avatar">
                </div>
                <div class="avatar h-7 w-7 hover:z-10">
                ...
                <div class="avatar h-7 w-7 hover:z-10">
                  <img class="rounded-full ring ring-white dark:ring-navy-700" src="{{asset('images/avatar/avatar-12.jpg')}}" alt="avatar">
                </div>
              </div>
              <button class="btn h-7 w-7 rounded-full bg-slate-150 p-0 font-medium text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80 dark:bg-navy-500 dark:text-navy-50 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 rotate-45" fill="none" viewbox="0 0 24 24" stroke="currentColor">
            ...
            <li class="timeline-item">
              ...
              <div class="timeline-item-content flex-1 pl-4">
                ...
                <div class="avatar mt-2 h-20 w-20">
                  <img class="mask is-squircle" src="{{asset('images/avatar/avatar-19.jpg')}}" alt="avatar">
                </div>
              </div>
            </li>
            <li class="timeline-item">
              ...
              <div class="timeline-item-content flex-1 pl-4">
                ...
                <div class="mt-4 grid grid-cols-3 gap-3">
                  <img class="rounded-lg" src="{{asset('images/object/object-1.jpg')}}" alt="image">
                  <img class="rounded-lg" src="{{asset('images/object/object-2.jpg')}}" alt="image">
                  <img class="rounded-lg" src="{{asset('images/object/object-3.jpg')}}" alt="image">
                  <img class="rounded-lg" src="{{asset('images/object/object-4.jpg')}}" alt="image">
                  <img class="rounded-lg" src="{{asset('images/object/object-5.jpg')}}" alt="image">
                  <img class="rounded-lg" src="{{asset('images/object/object-6.jpg')}}" alt="image">
                </div>
                <div class="mt-4">
